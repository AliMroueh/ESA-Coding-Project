...
<head>
  ...
  <link href="cssWalaa/styleProcc.css" rel="stylesheet">
<style>
  ...
  <!-- End Header -->
    ...
    <div class="container pt-20 mt-5 text-center">
        <h2>Pocessin to checkout</h2>
        <p>Choose your service:</p>                  
        <ul class="pagination pagination-center-lg">
          <li><a href="deliveryaddress.html" id="delivery">Delivery-</a></li>
          <li><a href="takeaway.html" id="takeaway">Take away-</a></li>
          <li><a href="ontable.html" id="ontable">On table</a></li>
    ...
    <!-- <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#deliveryaddress.html">Action</a></li>
        <li><a class="dropdown-item" href="#takeaway.html">Another action</a></li>
        <li><a class="dropdown-item" href="#ontable.html">Something else here</a></li>
      </ul>
    </div> -->
